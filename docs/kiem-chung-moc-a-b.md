...
| ----- | ------------------------------------------------ | -------------------------------------------------------------- |
| **A** | Lịch engine tính ra, PM có tin không?            | PM quyết bỏ qua; quyết định ghi _"vẫn nên làm khi thuận tiện"_ |
...
trượt Mốc B: _"quay lại bàn về độ mịn WBS"_ — tức là giả định 0.25 MD (Phụ lục A #19) sai, và
...
1. **S3 Gantt, cả dự án.** Ngày kết thúc có hợp lý so với khối lượng không? `J07` báo
   _"Resource limits stretch the schedule X% beyond the ideal plan"_ — con số X có khớp cảm
...
§10.5 thiết kế cho quy mô _"từ 300 dòng xuống 20–40 dòng thật sự cần nhìn"_. Dữ liệu demo
